...
# Qt
export QT_SHORT_VERSION=6.2.7
echo "Download Qt $QT_SHORT_VERSION"
export QT_PATH=$HOME/Qt/$QT_SHORT_VERSION/
export PATH=$PATH:$QT_PATH/bin
echo "PATH=$PATH" >>$GITHUB_ENV
wget -nv -O qt.zip https://github.com/cbjeukendrup/musescore_build_qt/releases/download/v10840433862/Qt-${QT_SHORT_VERSION}-macOS.zip
mkdir -p $QT_PATH
